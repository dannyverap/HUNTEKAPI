...
AWS_BUCKET_NAME = "pruebafotosperfil"
AWS_REGION_NAME = "us-east-2"
AWS_ACCESS_KEY_ID = "AKIASXEQXYJI5YLVS6YJ"
AWS_SECRET_ACCESS_KEY = "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"
...
async def upload_files(
    ...
    # Utilizar el servicio CRUDUserFilesService para crear y guardar el objeto en la base de datos
